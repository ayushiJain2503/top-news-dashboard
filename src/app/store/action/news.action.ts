...
export const newsLoad = createAction(NEWS_LOAD, props<{ category: string }>());

export const newsLoadSuccess = createAction(NEWS_LOAD_SUCCESS);
...
export const newsSearchSuccess = createAction(NEWS_SEARCH_SUCCESS);
